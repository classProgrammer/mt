...
\begin{table}[h]
    ...
    \begin{tabular}{ c | l | c | c   }
        ...
        10 & [Sophia Richter] feels sick today & \xmark & \xmark\\ \hline 
    \end{tabular}
    \caption{Sickness Utterances} \label{tab:sickness_utterances}
\end{table} \noindent
...
\begin{table}[h]
    ...
    \end{tabular}
    \caption{Vacation Utterances} \label{tab:vacation_utterances}
\end{table} \noindent
