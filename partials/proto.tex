...
Watson Assistant\cite{watsonassistant} is the cloud chatbot technology of IBM hosted in the IBM cloud.
...
The vacation use-case is quite similar in structure and requires a date-span entity.
