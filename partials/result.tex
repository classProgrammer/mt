...
The evaluation of the usability of the frameworks is based on the 
subjective impressions from the prototype development section.
A major part of the chatbot development process is the creation of 
intents entities and utterances.
The concepts are implemented in the same way for all technologies except 
Rasa where they need to be defined in multiple files to achieve the same result.
This means that it's equally easy to implement intents, entities, and 
utterances wiht Dialogflow, LUIS, and Watson Assistant and easier than 
with Rasa.
The structuring of the user interfaces of the cloud bots is similar.
The easiest interface was the one of LUIS which was expected since it has 
no dialog handeling mechanism.
The simplest UI of the three chatbots was the one of Dialogflow since it was
more transparent than the interface of Watson Assistant.
Rasa-X was inbetween Dialogflow and Watson Assistant.
