...
\begin{table}[h]
    ...
    \begin{tabular}{ l | l | c | c | c | c }
        ...
        Luis & System & \cmark & \cmark & \xmark & \cmark \\
    \end{tabular}
...
Rasa wins the technology category with an f-score of 0.865 when Duckling is used for dates and 
Spacy is used for persons.
...
\begin{table}[h]
    ...
    \begin{tabular}{ l | l | c | c | c | c | c | c | c | c }
        ...
        Spacy+Duckling & Summary & 16 & 1 & 2 & 3 & 0.888 & 0.842 & 0.865 & 22 \\ \hline
    \end{tabular}
...
\begin{table}[h]
    ...
    \begin{tabular}{ c | c | c | c | c | c  }
        No & Input & Expected & Technology & Recognized & Extracted \\ 
                 &&          &            & Correctly  & Value     \\ \hline \hline
        \multirow{8}{*}{5} &\multirow{8}{*}{\shortstack[l]{06/07 to 06/06}} & \multirow{8}{*}{TP} 
                 ...
                 &&&                          &                        & 2020-06-06 \\
                 \hline
        \multirow{8}{*}{6} &\multirow{8}{*}{\shortstack[l]{from tomorrow to\\06.06.2020}} & \multirow{8}{*}{TP} 
                 & \multirow{2}{*}{Watson} & \multirow{2}{*}{\cmark} & 2020-06-02 \\
                 &&&                          &                        & 2020-06-06 \\\cline{4-6}
