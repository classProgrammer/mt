...
not yet suitable for goal-oriented tasks.
...
The users feedback is a valuable source of information for the actual product and takes place after the 
framework has been choosen.
The NLU capabilities are important for the developers of the systems and help to choose the best framework 
for development.
...
but uses a goal-oriented setting for the comparison which is a taks oriented view of the problem.
...
In general, software developers can build language understanding without assistnace of a framework
...
focus on task-oriented systems, and \citet{singhbuilding} mentions both.
